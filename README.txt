...
│   │   ├── 1.1.3 General
│   │   │   ├── 1.1.3.1 (a+b x^n)^p.pdf
│   │   │   ├── 1.1.3.2 (c x)^m (a+b x^n)^p.pdf
│   │   │   ├── 1.1.3.3 (a+b x^n)^p (c+d x^n)^q.pdf
│   │   │   ├── 1.1.3.4 (e x)^m (a+b x^n)^p (c+d x^n)^q.pdf
│   │   │   ├── 1.1.3.5 (a+b x^n)^p (c+d x^n)^q (e+f x^n)^r.pdf
│   │   │   ├── 1.1.3.6 (g x)^m (a+b x^n)^p (c+d x^n)^q (e+f x^n)^r.pdf
│   │   │   ├── 1.1.3.7 P(x) (a+b x^n)^p.pdf
│   │   │   └── 1.1.3.8 P(x) (c x)^m (a+b x^n)^p.pdf
│   │   └── 1.1.4 Improper
│   │       ├── 1.1.4.1 (a x^j+b x^n)^p.pdf
│   │       ├── 1.1.4.2 (c x)^m (a x^j+b x^n)^p.pdf
│   │       ├── 1.1.4.3 (e x)^m (a x^j+b x^k)^p (c+d x^n)^q.pdf
│   │       └── 1.1.4.4 P(x) (c x)^m (a x^j+b x^n)^p.pdf
│   ├── 1.2 Trinomial products
│   │   ├── 1.2.1 Quadratic
│   │   │   ├── 1.2.1.1 (a+b x+c x^2)^p.pdf
│   │   │   ├── 1.2.1.2 (d+e x)^m (a+b x+c x^2)^p.pdf
│   │   │   ├── 1.2.1.3 (d+e x)^m (f+g x) (a+b x+c x^2)^p.pdf
│   │   │   ├── 1.2.1.4 (d+e x)^m (f+g x)^n (a+b x+c x^2)^p.pdf
│   │   │   ├── 1.2.1.5 (a+b x+c x^2)^p (d+e x+f x^2)^q.pdf
│   │   │   ├── 1.2.1.6 (g+h x)^m (a+b x+c x^2)^p (d+e x+f x^2)^q.pdf
│   │   │   ├── 1.2.1.7 (a+b x+c x^2)^p (d+e x+f x^2)^q (A+B x+C x^2).pdf
│   │   │   ├── 1.2.1.8 P(x) (a+b x+c x^2)^p.pdf
│   │   │   └── 1.2.1.9 P(x) (d+e x)^m (a+b x+c x^2)^p.pdf
│   │   ├── 1.2.2 Quartic
│   │   │   ├── 1.2.2.1 (a+b x^2+c x^4)^p.pdf
│   │   │   ├── 1.2.2.2 (d x)^m (a+b x^2+c x^4)^p.pdf
│   │   │   ├── 1.2.2.3 (d+e x^2)^q (a+b x^2+c x^4)^p.pdf
...
│   │   │   ├── 1.2.3.3 (d+e x^n)^q (a+b x^n+c x^(2 n))^p.pdf
│   │   │   ├── 1.2.3.4 (f x)^m (d+e x^n)^q (a+b x^n+c x^(2 n))^p.pdf
│   │   │   ├── 1.2.3.5 P(x) (a+b x^n+c x^(2 n))^p.pdf
│   │   │   └── 1.2.3.6 P(x) (d x)^m (a+b x^n+c x^(2 n))^p.pdf
│   │   └── 1.2.4 Improper
│   │       ├── 1.2.4.1 (a x^q+b x^n+c x^(2 n-q))^p.pdf
│   │       ├── 1.2.4.2 (d x)^m (a x^q+b x^n+c x^(2 n-q))^p.pdf
│   │       ├── 1.2.4.3 (d+e x^(n-q)) (a x^q+b x^n+c x^(2 n-q))^p.pdf
│   │       └── 1.2.4.4 (f x)^m (d+e x^(n-q)) (a x^q+b x^n+c x^(2 n-q))^p.pdf
│   └── 1.3 Miscellaneous
│       ├── 1.3.1 P(x)^p.pdf
│       ├── 1.3.2 P(x) Q(x)^p.pdf
│       ├── 1.3.3 Miscellaneous algebraic functions.pdf
│       └── 1.3.4 Normalizing algebraic functions.pdf
├── 2 Exponentials
│   ├── 2.1 (c+d x)^m (a+b (F^(g (e+f x)))^n)^p.pdf
│   ├── 2.2 (c+d x)^m (F^(g (e+f x)))^n (a+b (F^(g (e+f x)))^n)^p.pdf
│   └── 2.3 Miscellaneous exponentials.pdf
├── 3 Logarithms
│   ├── 3.1 u (a+b log(c x^n))^p.pdf
│   ├── 3.2 u (a+b log(c (d+e x)^n))^p.pdf
│   ├── 3.3 u (a+b log(c (d+e x^m)^n))^p.pdf
│   ├── 3.4 u log(e (f (a+b x)^p (c+d x)^q)^r)^s.pdf
│   └── 3.5 Miscellaneous logarithms.pdf
├── 4 Trig functions
│   ├── 4.1 Sine
│   │   ├── 4.1.0.1 (a sin)^m (b trg)^n.pdf
│   │   ├── 4.1.0.2 (a trg)^m (b tan)^n.pdf
│   │   ├── 4.1.0.3 (a csc)^m (b sec)^n.pdf
│   │   ├── 4.1.10 (c+d x)^m (a+b sin)^n.pdf
│   │   ├── 4.1.1.1 (a+b sin)^n.pdf
│   │   ├── 4.1.11 (e x)^m (a+b x^n)^p sin.pdf
│   │   ├── 4.1.12 (e x)^m (a+b sin(c+d x^n))^p.pdf
│   │   ├── 4.1.1.2 (g cos)^p (a+b sin)^m.pdf
│   │   ├── 4.1.13 (d+e x)^m sin(a+b x+c x^2)^n.pdf
│   │   ├── 4.1.1.3 (g tan)^p (a+b sin)^m.pdf
│   │   ├── 4.1.2.1 (a+b sin)^m (c+d sin)^n.pdf
│   │   ├── 4.1.2.2 (g cos)^p (a+b sin)^m (c+d sin)^n.pdf
│   │   ├── 4.1.2.3 (g sin)^p (a+b sin)^m (c+d sin)^n.pdf
│   │   ├── 4.1.3.1 (a+b sin)^m (c+d sin)^n (A+B sin).pdf
│   │   ├── 4.1.4.1 (a+b sin)^m (A+B sin+C sin^2).pdf
│   │   ├── 4.1.4.2 (a+b sin)^m (c+d sin)^n (A+B sin+C sin^2).pdf
│   │   ├── 4.1.5 trig^m (a cos+b sin)^n.pdf
│   │   ├── 4.1.6 (a+b cos+c sin)^n.pdf
...
│   │   ├── 5.1.2 (d x)^m (a+b arcsin(c x))^n.pdf
│   │   ├── 5.1.3 (d+e x^2)^p (a+b arcsin(c x))^n.pdf
...
│   │   ├── 7.1.2 (d x)^m (a+b arcsinh(c x))^n.pdf
│   │   ├── 7.1.3 (d+e x^2)^p (a+b arcsinh(c x))^n.pdf
...
│   ├── 8.4 Trig integral functions.pdf
│   ├── 8.5 Hyperbolic integral functions.pdf
│   ├── 8.6 Gamma functions.pdf
│   ├── 8.7 Zeta function.pdf
│   ├── 8.8 Polylogarithm function.pdf
│   └── 8.9 Product logarithm function.pdf
└── 9 Miscellaneous
    ├── 9.1 Integrand simplification rules.pdf
    ├── 9.2 Derivative integration rules.pdf
